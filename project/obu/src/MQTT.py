...
class MQTT:
    ...
    """
    def __init__(self, brokerHostName: str, brokerHostPort: str, gasTopic: str, initTopic: str, controllerTopic: str) -> None:
        """
    ...
    def _on_message(self, client, userdata, message) -> None:
        ...
        if message.topic == self.controllerTopic:
            logging.debug("Received message from controller")
            ...
            logging.debug("Received initialization message")
